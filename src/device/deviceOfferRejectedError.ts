 ...
 * (a thrown error). `DeviceProvider` uses this to decide whether `onConnectFailed()` should run -
 * it shouldn't for manager-level decisions, only for the provider's own failed attempt.
 */
